...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-[#262626] text-zinc-100 antialiased">

        {{-- Header --}}
        <header class="fixed inset-x-0 top-0 z-50 h-[120px] border-b border-zinc-700 bg-[#262626]">
            <div class="mx-auto flex h-full max-w-6xl items-center justify-between px-5 sm:px-8">
                <a href="{{ url('/') }}" class="flex items-center gap-3 underline-offset-4 hover:underline">
                    <img src="{{ asset('favicon.png') }}" alt="BasicEMS" class="h-8 w-8 object-contain">
                    <span class="text-base font-semibold tracking-wide text-zinc-100">BasicEMS</span>
                </a>

                {{-- Desktop nav --}}
                <nav class="hidden items-center gap-1 sm:flex sm:gap-2">
                    <a
                        href="https://github.com/valasme/basic-ems"
                        target="_blank"
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a
                                href="{{ url('/dashboard') }}"
                                class="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-zinc-400 underline-offset-4 transition hover:text-zinc-100 hover:underline"
                            >
                                Dashboard
                            </a>
                        @else
                ...
                <button
                    id="open-mobile-menu"
                    type="button"
                    class="inline-flex items-center justify-center rounded-md p-2 text-zinc-400 transition hover:text-zinc-100 sm:hidden"
            ...
            <div
                id="mobile-menu"
                class="fixed inset-0 z-[100] hidden bg-[#262626] sm:hidden"
                inert
            >
                <div class="relative h-full w-full">
                    <button
                        ...
                        type="button"
                        class="absolute right-5 top-10 z-20 inline-flex items-center justify-center rounded-md p-2 text-zinc-400 transition hover:text-zinc-100"
                    ...
                    <nav class="absolute inset-0 z-10 flex flex-col items-center justify-center gap-8">
                        @if (Route::has('login'))
                            @auth
                                <a
                                    href="{{ url('/dashboard') }}"
                                    data-menu-link
                                    class="text-2xl font-medium text-zinc-100 underline-offset-4 transition hover:underline"
                                >
                                    Dashboard
                                </a>
                            @else
                        ...
                        <a
                            ...
                            rel="noopener noreferrer"
                            data-menu-link
                            class="inline-flex items-center gap-2 text-2xl font-medium text-zinc-100 underline-offset-4 transition hover:underline"
                        >
        ...
        <main class="mx-auto max-w-6xl px-5 sm:px-8">
            ...
            <section class="flex flex-col items-center py-20 text-center sm:py-28">
                <h1 class="text-5xl font-bold tracking-tight text-zinc-50 sm:text-6xl md:text-7xl">Modern EMS</h1>
                <p class="mt-6 max-w-2xl text-lg leading-relaxed text-zinc-400">
                    Lightweight employee management for very small businesses and tiny teams. Track people, tasks, notes, attendance, and pay dates — without enterprise complexity.
                </p>
                <div class="mt-10 flex flex-wrap items-center justify-center gap-3">
                    @if (Route::has('login'))
                        @auth
                            <a
                                href="{{ url('/dashboard') }}"
                                class="inline-flex items-center justify-center rounded-md border border-zinc-700 px-6 py-2.5 text-sm font-medium text-zinc-300 underline-offset-4 transition hover:text-zinc-100 hover:underline"
                            >
                                Open Dashboard
                            </a>
                        @else
                            ...
                            <a
                                href="{{ route('login') }}"
                                class="inline-flex items-center justify-center rounded-md px-6 py-2.5 text-sm font-medium text-zinc-400 underline-offset-4 transition hover:text-zinc-100 hover:underline"
                            >
                                Sign in
                            </a>
                        @endauth
            ...
            <section class="py-12">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Employees</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Directory with contact info, department, job title, and work schedules.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Attendance</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Daily attendance tracking with per-employee records.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Tasks</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Task management with status, priority, due dates, and employee assignment.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Critical Tasks</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Highlight urgent open tasks with configurable filter and sort modes.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Notes</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Quick notes system with title, description, and search.</p>
                    </div>
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Due Payments</p>
                        <p class="mt-2 text-sm leading-relaxed text-zinc-400">Track upcoming pay dates with urgency cues and payment status.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="py-12">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="flex h-40 flex-col justify-center rounded-md border border-zinc-700 bg-[#262626] p-8">
                        <p class="text-sm font-semibold text-zinc-100">Laravel 12</p>
        ...
        {{-- Footer --}}
        <footer class="mt-12 border-t border-zinc-700">
            <div class="mx-auto flex max-w-6xl flex-col items-center gap-6 px-5 py-10 sm:flex-row sm:justify-between sm:px-8">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('favicon.png') }}" alt="BasicEMS" class="h-6 w-6 object-contain">
                    <span class="text-sm font-medium text-zinc-400">BasicEMS</span>
                </div>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="inline-flex items-center gap-2 text-xs text-zinc-400 underline-offset-4 transition hover:text-zinc-100 hover:underline"
                >
